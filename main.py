...
def predefined_messages(message):
	...
	if (('понедельник' in msg and 'пн' in msg) or ('вторник' in msg and 'вт' in msg) or ('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg) or ('четверг' in msg and 'чт' in msg) or ('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg) or ('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg) or ('воскресенье' in msg and 'вс' in msg)) and not (('понедельник' in msg and 'пн' in msg) and ('вторник' in msg and 'вт' in msg) and ('среда' in msg and 'ср' in msg) and ('среда' in msg and 'среду' in msg) and ('среду' in msg and 'ср' in msg) and ('четверг' in msg and 'чт' in msg) and ('пятница' in msg and 'пт' in msg) and ('пятница' in msg and 'пятницу' in msg) and ('пятницу' in msg and 'пт' in msg) and ('суббота' in msg and 'сб' in msg) and ('суббота' in msg and 'субботу' in msg) and ('субботу' in msg and 'сб' in msg) and ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
