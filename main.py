        ...
        if uid in first_group.keys():
            if date_weekday == 0:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_1SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF or CS18_SCHEDULE_LIGHTWEEK_1GROUP_2SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF:
                    ...
                    if uid in second_group_eng.keys():
                        last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_MONDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_MONDAY)))[-2:])
                    elif uid in second_group_eng.keys():
                        last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_MONDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_MONDAY)))[-2:])
            if date_weekday == 1:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_TUESDAY == SCHEDULE_TUESDAY_DAYOFF:
                    ...
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_TUESDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_TUESDAY)))[-2:])
            if date_weekday == 2:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_WEDNESDAY == SCHEDULE_WEDNESDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_WEDNESDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_WEDNESDAY)))[-2:])
            if date_weekday == 3:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_THURSDAY == SCHEDULE_THURSDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_THURSDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_THURSDAY)))[-2:])
            if date_weekday == 4:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_FRIDAY == SCHEDULE_FRIDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_FRIDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_FRIDAY)))[-2:])
            if date_weekday == 5:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_SATURDAY == SCHEDULE_SATURDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_SATURDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_SATURDAY)))[-2:])
            if date_weekday == 6:
                if CS18_SCHEDULE_LIGHTWEEK_1GROUP_SUNDAY == SCHEDULE_SUNDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_SUNDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_SUNDAY)))[-2:])
        elif uid in second_group.keys():
            if date_weekday == 0:
        ...
        if uid in first_group.keys():
            if date_weekday == 0:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_1SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF or CS18_SCHEDULE_DARKWEEK_1GROUP_2SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF:
                    ...
                    if uid in second_group_eng.keys():
                        last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY)))[-2:])
                    elif uid in second_group_eng.keys():
                        last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY)))[-2:])
            if date_weekday == 1:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_TUESDAY == SCHEDULE_TUESDAY_DAYOFF:
                    ...
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_TUESDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_TUESDAY)))[-2:])
            if date_weekday == 2:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_WEDNESDAY == SCHEDULE_WEDNESDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_WEDNESDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_WEDNESDAY)))[-2:])
            if date_weekday == 3:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_THURSDAY == SCHEDULE_THURSDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_THURSDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_THURSDAY)))[-2:])
            if date_weekday == 4:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_FRIDAY == SCHEDULE_FRIDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_FRIDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_FRIDAY)))[-2:])
            if date_weekday == 5:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_SATURDAY == SCHEDULE_SATURDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_SATURDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_SATURDAY)))[-2:])
            if date_weekday == 6:
                if CS18_SCHEDULE_DARKWEEK_1GROUP_SUNDAY == SCHEDULE_SUNDAY_DAYOFF:
                    last_class_time = ""
                else:
                    last_class_time = str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_SUNDAY)))[-4:-2]) + ":" + str(int(''.join(filter(str.isdigit, CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_SUNDAY)))[-2:])
        elif uid in second_group.keys():
            if date_weekday == 0:
                if CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF or CS18_SCHEDULE_DARKWEEK_2GROUP_2SUBGROUP_MONDAY == SCHEDULE_MONDAY_DAYOFF:
                    last_class_time = ""
