...
def predefined_messages(message):
	...
	if (('понедельник' in msg or 'пн' in msg) or ('понедельник' in msg and 'пн' in msg)) and not (('вторник' in msg and 'вт' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or ('четверг' in msg and 'чт' in msg) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif (('вторник' in msg or 'вт' in msg) or ('вторник' in msg and 'вт' in msg)) and not (('понедельник' in msg or 'пн' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or ('четверг' in msg and 'чт' in msg) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif ((('среда' in msg or 'ср' in msg or 'среду' in msg)) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg))) and not ('понедельник' in msg or 'пн' in msg) and not (('вторник' in msg and 'вт' in msg) or ('четверг' in msg and 'чт' in msg) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif (('четверг' in msg or 'чт' in msg) or ('четверг' in msg and 'чт' in msg)) and not ('понедельник' in msg or 'пн' in msg) and not (('вторник' in msg and 'вт' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif ((('пятница' in msg and 'пт' in msg and 'пятницу' in msg)) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg))) and not ('понедельник' in msg or 'пн' in msg) and not (('вторник' in msg and 'вт' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or ('четверг' in msg and 'чт' in msg) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif ((('суббота' in msg and 'сб' in msg and 'субботу' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg))) and not ('понедельник' in msg or 'пн' in msg) and not (('вторник' in msg and 'вт' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or ('четверг' in msg and 'чт' in msg) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or ('воскресенье' in msg and 'вс' in msg)):
		contradiction = 'no'
	elif (('воскресенье' in msg or 'вс' in msg) or ('воскресенье' in msg and 'вс' in msg)) and not ('понедельник' in msg or 'пн' in msg) and not (('вторник' in msg and 'вт' in msg) or (('среда' in msg and 'ср' in msg) or ('среда' in msg and 'среду' in msg) or ('среду' in msg and 'ср' in msg)) or ('четверг' in msg and 'чт' in msg) or (('пятница' in msg and 'пт' in msg) or ('пятница' in msg and 'пятницу' in msg) or ('пятницу' in msg and 'пт' in msg)) or (('суббота' in msg and 'сб' in msg) or ('суббота' in msg and 'субботу' in msg) or ('субботу' in msg and 'сб' in msg))):
		contradiction = 'no'
	else:
		contradiction = 'yes'
	...
	if uid in first_group.keys() or uid in second_group.keys():
		...
		if weekorder == True:
			...
			if any(words in msg for words in classes_tuple):
					...
					if time_day_beg <= time_now <= time_uni_end:
						...
						if uid in first_group.keys():
							...
							if date_weekday + 1 == 7:
								...
								bot.send_message(cid, tomorrow_template + '\n\n' + CS18_SCHEDULE_LIGHTWEEK_2GROUP_SUNDAY, reply_to_message_id=mid)
				elif 'сегодня' in msg and 0 < days_matches < 2 and not any(words in msg for words in exceptions_tuple):
					if uid in first_group.keys():
						if date_weekday == 0:
							if uid in first_group_eng.keys():
								bot.send_message(cid, today_template + '\n\n' + CS18_SCHEDULE_LIGHTWEEK_1GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
						...
						if date_weekday == 0:
							...
							bot.send_message(cid, today_template + '\n\n' + CS18_SCHEDULE_LIGHTWEEK_2GROUP_SUNDAY, reply_to_message_id=mid)
				elif 'вчера' in msg and 0 < days_matches < 2 and not any(words in msg for words in exceptions_tuple):
					if uid in first_group.keys():
						if date_weekday - 1 == 0:
							if uid in first_group_eng.keys():
						...
						if date_weekday - 1 == 0:
							...
							bot.send_message(cid, yesterday_template + '\n\n' + CS18_SCHEDULE_LIGHTWEEK_2GROUP_SUNDAY, reply_to_message_id=mid)
				elif 'завтра' in msg and 0 < days_matches < 2 and not any(words in msg for words in exceptions_tuple):
					if uid in first_group.keys():
						if date_weekday + 1 == 7:
							if uid in first_group_eng.keys():
								bot.send_message(cid, tomorrow_template + '\n\n' + CS18_SCHEDULE_LIGHTWEEK_1GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
				...
				if 0 < days_matches < 2 and not any(words in msg for words in weekdays_tuple) and not any(words in msg for words in weekdays_sp_tuple) and not any(words in msg for words in weekdays_sh_tuple) and not any(words in msg for words in exceptions_tuple):
					if time_day_beg <= time_now <= time_uni_end:
						if uid in first_group.keys():
							if date_weekday == 0:
