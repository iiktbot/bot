...
def predefined_messages(message):
    ...
    if date_weekday == 0:
        today = "понедельник / сегодня"
        tomorrow = "вторник / завтра"
        yesterday = "воскресенье / вчера"
    elif date_weekday == 1:
        today = "вторник / сегодня"
        tomorrow = "среда / завтра"
        yesterday = "понедельник / вчера"
    elif date_weekday == 2:
        today = "среда / сегодня"
        tomorrow = "четверг / завтра"
        yesterday = "вторник / вчера"
    elif date_weekday == 3:
        today = "четверг / сегодня"
        tomorrow = "пятница / завтра"
        yesterday = "среда / вчера"
    elif date_weekday == 4:
        today = "пятница / сегодня"
        tomorrow = "суббота / завтра"
        yesterday = "четверг / вчера"
    elif date_weekday == 5:
        today = "суббота / сегодня"
        tomorrow = "воскресенье / завтра"
        yesterday = "пятница / вчера"
    elif date_weekday == 6:
        today = "воскресенье / сегодня"
            ...
            if not any(words in msg for words in days_tuple) and not any(words in msg for words in weekdays_tuple) and not any(words in msg for words in exceptions_tuple):
                if time_now < time_end:
                    ...
                    if uid in first_group.keys():
                        if date_weekday + 1 == 7:
                            if uid in first_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
                            elif uid in second_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_2SUBGROUP_MONDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 1:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_TUESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 2:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_WEDNESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 3:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_THURSDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 4:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_FRIDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 5:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_SATURDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 6:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_1GROUP_SUNDAY, reply_to_message_id=mid)
                    elif uid in second_group.keys():
                        if date_weekday + 1 == 7:
                            if uid in first_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
                            elif uid in second_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_2SUBGROUP_MONDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 1:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_TUESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 2:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_WEDNESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 3:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_THURSDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 4:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_FRIDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 5:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_SATURDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 6:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_LIGHTWEEK_2GROUP_SUNDAY, reply_to_message_id=mid)
                    else:
                        bot.send_message(cid, "вряд ли ты здесь учишься", reply_to_message_id=mid)
            ...
            if not any(words in msg for words in days_tuple) and not any(words in msg for words in weekdays_tuple) and not any(words in msg for words in exceptions_tuple):
                if time_now < time_end:
                    ...
                    if uid in first_group.keys():
                        if date_weekday + 1 == 7:
                            if uid in first_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
                            elif uid in second_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_2SUBGROUP_MONDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 1:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_TUESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 2:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_WEDNESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 3:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_THURSDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 4:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_FRIDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 5:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_SATURDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 6:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_1GROUP_SUNDAY, reply_to_message_id=mid)
                    elif uid in second_group.keys():
                        if date_weekday + 1 == 7:
                            if uid in first_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_1SUBGROUP_MONDAY, reply_to_message_id=mid)
                            elif uid in second_group_eng.keys():
                                bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_2SUBGROUP_MONDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 1:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_TUESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 2:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_WEDNESDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 3:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_THURSDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 4:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_FRIDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 5:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_SATURDAY, reply_to_message_id=mid)
                        elif date_weekday + 1 == 6:
                            bot.send_message(cid, time_over_template + CS18_SCHEDULE_DARKWEEK_2GROUP_SUNDAY, reply_to_message_id=mid)
                    else:
                        bot.send_message(cid, "вряд ли ты здесь учишься", reply_to_message_id=mid)
            elif "сегодня" in msg and not any(words in msg for words in today_tuple) and not any(words in msg for words in exceptions_tuple):
                if uid in first_group.keys():
